#!/usr/bin/env python3
"""Run 500-sample eval: FP16 attn + FP16 embed_tokens + no AWQ."""
import json
import sys
...
COMPRESSED_DIR = str(Path.home() / "models" / "Qwen2.5-1.5B-Instruct-squished-fp16embed")
MODEL_ARGS     = f"model_dir={MODEL_DIR},compressed_dir={COMPRESSED_DIR}"
RESULTS_DIR    = ROOT / "dev" / "results"
RESULTS_DIR.mkdir(parents=True, exist_ok=True)

print(f"\n{'='*60}")
print("  FP16 attn+embed, no AWQ — 500-sample eval")
...
out = {
    "model": "Qwen2.5-1.5B-FP16attn-FP16embed-noAWQ-INT4g16",
    "compressed_dir": COMPRESSED_DIR, "limit": 500, "num_fewshot": 0,
    "results": summary, "all_beat_bf16": all_beat,
}
out_path = RESULTS_DIR / "accuracy_fp16embed_500.json"
