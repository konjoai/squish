#!/usr/bin/env python3
"""Run 500-sample accuracy eval against the OLD symmetric INT4 model for comparison."""
import sys
import json
...
print(f"\n{'='*60}")
print("  Symmetric INT4 (old) — 500-sample accuracy eval")
...
out = {
    "model":          "Qwen2.5-1.5B-INT4-symmetric-old",
    "compressed_dir": COMPRESSED_DIR,
    "limit":          500,
    "num_fewshot":    0,
    "results":        summary,
}
out_path = RESULTS_DIR / "accuracy_int4_sym_old_500.json"
