...
Usage example::
    ...
    import numpy as np
    from squish.token.act_sparsity import SparsityConfig, ActSparsityPredictor, SparseFFNGate
    ...
    def calibrate(
        ...
        Args:
            emit_profile: When ``True`` returns a ``(sparsity_map, NeuronProfile)``
                ...
                for use with :mod:`squish.hardware.neuron_router`.
            profile_config: Optional :class:`squish.hardware.neuron_profile.NeuronProfileConfig`
