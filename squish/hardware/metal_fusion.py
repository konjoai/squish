...
Usage::
    ...
    from squish.hardware.metal_fusion import MetalFusionConfig, MetalFusionKernels
    from squish.hardware.metal_fusion import fused_rope_qk, fused_swiglu, fused_int8_kv_attn
