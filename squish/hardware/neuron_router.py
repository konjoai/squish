...
Uses a :class:`~squish.hardware.neuron_profile.NeuronProfile` to split each MLP
...
Example::
    ...
    from squish.hardware.neuron_profile import load_profile
    from squish.hardware.neuron_router import NeuronRouterConfig, NeuronRouter
...
class NeuronRouterConfig:
    ...
    Attributes:
        profile:      A :class:`~squish.hardware.neuron_profile.NeuronProfile` that
