...
class TestPrefillCached:
    def test_returns_float32_numpy_array(self):
        ...
        from squish.speculative.speculative import _prefill_cached
...
class TestDecodeStepCached:
    def test_returns_float32_vector(self):
        ...
        from squish.speculative.speculative import _decode_step_cached
...
class TestDecodeMultiCached:
    def test_returns_all_rows(self):
        ...
        from squish.speculative.speculative import _decode_multi_cached
