...
class TestStructuredPrune:
    def test_imports(self):
        from squish.structured_prune import PruneConfig, StructuredPruner, PruneStats
...
class TestLayerFuse:
    def test_imports(self):
        from squish.layer_fuse import FusionConfig, LayerFuser, FusionStats
...
class TestWeightSharing:
    def test_imports(self):
        from squish.weight_sharing import SharingConfig, WeightSharer, SharingStats
...
class TestQuantCalib:
    def test_imports(self):
        from squish.quant_calib import CalibConfig, CalibResult, QuantCalibrator, CalibStats
    ...
    def test_calibrate_returns_result(self):
        from squish.quant_calib import CalibConfig, QuantCalibrator, CalibResult
...
class TestSparseWeight:
    def test_imports(self):
        from squish.sparse_weight import SparsityConfig, SparseWeightStore, SparseStats
...
class TestDeltaCompress:
    ...
    def test_compression_ratio_static(self):
        from squish.delta_compress import DeltaCompressor
