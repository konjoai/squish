...
from squish.kv.semantic_cache import (
    _EMBED_DIM,
    SquishSemanticCache,
    _word_hash_embed,
)
...
# even when squish.kv.semantic_cache.sqlite3.connect is patched.
...
def cache(tmp_path):
    ...
    with mock.patch(
        "squish.kv.semantic_cache.sqlite3.connect",
...
_CONN_PATCH = "squish.kv.semantic_cache.sqlite3.connect"
