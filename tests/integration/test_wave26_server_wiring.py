...
def test_adaptive_batcher_import():
    from squish.serving.adaptive_batcher import AdaptiveBatchController, BatchObjective
...
def test_safety_layer_import():
    from squish.serving.safety_layer import SafetyClassifier, SafetyConfig
