...
class TestVPTQWiring:
    ...
    def test_compress_decompress_roundtrip(self):
        from squish.quant.vptq import VPTQConfig, VPTQLayer, VPTQQuantizer
    ...
    def test_codebook_fit_encode_decode(self):
        from squish.quant.vptq import VPTQCodebook
    ...
    def test_decompress_layer_function(self):
        from squish.quant.vptq import VPTQConfig, VPTQQuantizer, decompress_layer
...
class TestLayerSkipWiring:
    def test_import(self):
        from squish.token.layer_skip import ConfidenceEstimator, EarlyExitConfig, EarlyExitDecoder
    ...
    def test_stats_counters(self):
        from squish.token.layer_skip import EarlyExitStats
...
class TestSWIFTWiring:
    def test_import(self):
        from squish.speculative.swift import SWIFTConfig, SWIFTDecoder, SWIFTLayerConfig
    ...
    def test_config_defaults(self):
        from squish.speculative.swift import SWIFTConfig
    ...
    def test_layer_config_serialization(self):
        from squish.speculative.swift import SWIFTLayerConfig
    ...
    def test_stats_acceptance_rate(self):
        from squish.speculative.swift import SWIFTStats
...
class TestMirrorSDWiring:
    ...
    def test_config_defaults(self):
        from squish.speculative.mirror_sd import MirrorSDConfig
    ...
    def test_draft_pipeline_step(self):
        from squish.speculative.mirror_sd import MirrorDraftPipeline, MirrorSDConfig
    ...
    def test_stats_mean_accepted(self):
        from squish.speculative.mirror_sd import MirrorSDStats
...
class TestSparseVerifyWiring:
    ...
    def test_reuse_cache_record_and_query(self):
        from squish.speculative.sparse_verify import InterDraftReuseCache
    ...
    def test_stats_counters(self):
        from squish.speculative.sparse_verify import SparseVerifyStats
...
class TestRobustSchedulerWiring:
    ...
    def test_length_interval_properties(self):
        from squish.serving.robust_scheduler import LengthInterval
    ...
    def test_balanced_scheduler_pressure(self):
        from squish.serving.robust_scheduler import ABalancedScheduler, RobustSchedulerConfig
...
class TestSemanticCacheWiring:
    def test_import(self):
        from squish.kv.semantic_cache import SquishSemanticCache
...
class TestIPWWiring:
    ...
    def test_measurement_derived_properties(self):
        from squish.token.ipw import IPWMeasurement
...
class TestPowerMonitorWiring:
    def test_import(self):
        from squish.serving.power_monitor import POWER_CONFIGS, PowerModeConfig, PowerMonitor
    ...
    def test_power_mode_config_fields(self):
        from squish.serving.power_monitor import POWER_CONFIGS
    ...
    def test_get_power_source_returns_valid(self):
        from squish.serving.power_monitor import PowerMonitor
    ...
    def test_apply_mode_function(self):
        from squish.serving.power_monitor import apply_mode
