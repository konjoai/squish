...
class TestAdaServeWiring:
    def test_import(self):
        from squish.serving.ada_serve import AdaServeConfig, AdaServeScheduler, SLOTarget
    ...
    def test_config_defaults(self):
        from squish.serving.ada_serve import AdaServeConfig
        cfg = AdaServeConfig()
    ...
    def test_slo_target_priority_range(self):
        from squish.serving.ada_serve import SLOTarget
...
class TestConfSpecWiring:
    ...
    def test_config_defaults(self):
        from squish.speculative.conf_spec import ConfSpecConfig
        cfg = ConfSpecConfig()
...
class TestSeqPackingWiring:
    ...
    def test_config_defaults(self):
        from squish.streaming.seq_packing import PackingConfig
        cfg = PackingConfig()
    ...
    def test_pack_sequences(self):
        from squish.streaming.seq_packing import PackedBatch, PackingConfig, SequencePacker
...
class TestMetaReasonerWiring:
    def test_import(self):
        from squish.context.meta_reasoner import MetaReasoner, MetaReasonerConfig
    ...
    def test_config_defaults(self):
        from squish.context.meta_reasoner import MetaReasonerConfig
    ...
    def test_compute_entropy_static(self):
        from squish.context.meta_reasoner import MetaReasoner
...
class TestYOCOWiring:
    def test_import(self):
        from squish.attention.yoco import YOCOConfig, YOCOKVStore
    ...
    def test_schedule_reduction_factor(self):
        from squish.attention.yoco import YOCOConfig, YOCOSchedule
...
class TestCLAWiring:
    def test_import(self):
        from squish.attention.cla import CLAConfig, CLALayerSpec
    ...
    def test_schedule_generates_correct_specs(self):
        from squish.attention.cla import CLAConfig, CLALayerSpec, CLASchedule
    ...
    def test_reduction_factor_within_bounds(self):
        from squish.attention.cla import CLAConfig, CLASchedule
...
class TestKVSharerWiring:
    def test_import(self):
        from squish.kv.kvsharer import KVSharerCalibrator, KVSharerConfig
        cfg  = KVSharerConfig(n_layers=8, similarity_threshold=0.95)
        cal  = KVSharerCalibrator(cfg)
        assert cal is not None

    def test_config_defaults(self):
        from squish.kv.kvsharer import KVSharerConfig
        cfg = KVSharerConfig()
    ...
    def test_record_and_compute_share_map(self):
        from squish.kv.kvsharer import KVShareMap, KVSharerCalibrator, KVSharerConfig
        rng = np.random.default_rng(0)
...
class TestDiffKVWiring:
    ...
    def test_config_defaults(self):
        from squish.kv.diffkv import DiffKVConfig
        cfg = DiffKVConfig()
    ...
    def test_get_policy_returns_diffkv_policy(self):
        from squish.kv.diffkv import DiffKVConfig, DiffKVPolicy, DiffKVPolicyManager
...
class TestParisKVWiring:
    ...
    def test_config_defaults(self):
        from squish.kv.paris_kv import ParisKVConfig
        cfg = ParisKVConfig()
...
class TestKVTunerWiring:
    def test_import(self):
        from squish.kv.kvtuner import KVTunerCalibrator, KVTunerConfig
    ...
    def test_record_and_search(self):
        from squish.kv.kvtuner import KVQuantConfig, KVTunerCalibrator, KVTunerConfig
        rng = np.random.default_rng(0)
