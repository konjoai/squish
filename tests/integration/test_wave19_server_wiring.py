...
class TestFP8QuantWiring:
    def test_import_and_config_properties(self):
        from squish.quant.fp8_quant import FP8Config
    ...
    def test_encode_decode_roundtrip_e4m3(self):
        from squish.quant.fp8_quant import fp8_decode, fp8_encode_e4m3
    ...
    def test_quantizer_encode_decode_per_channel(self):
        from squish.quant.fp8_quant import FP8Config, FP8Quantizer, FP8Tensor
    ...
    def test_fp8_tensor_properties_and_e5m2_path(self):
        from squish.quant.fp8_quant import FP8Config, FP8Quantizer, fp8_encode_e5m2
        rng = np.random.default_rng(2)
        x = rng.standard_normal(512).astype(np.float32)
        codes, scale = fp8_encode_e5m2(x)
        assert codes.dtype == np.uint8
        # FP8Tensor compression ratio must be 4x vs float32
        from squish.quant.fp8_quant import FP8Tensor
...
class TestMXQuantWiring:
    def test_import_and_config_properties(self):
        from squish.quant.mx_quant import MXConfig
    ...
    def test_quantizer_encode_decode_roundtrip_mx4(self):
        from squish.quant.mx_quant import MXConfig, MXQuantizer, MXTensor
...
class TestFlashDecodeWiring:
    ...
    def test_merge_split_results(self):
        from squish.attention.flash_decode import FlashDecodeSplit, merge_split_results
...
class TestPagedKVWiring:
    def test_import_and_config_validation(self):
        from squish.kv.paged_kv import PagedKVConfig
    ...
    def test_paged_kv_stats_properties(self):
        from squish.kv.paged_kv import PagedKVCache, PagedKVConfig, PagedKVStats
...
class TestGQAWiring:
    ...
    def test_cache_append_and_get_kv(self):
        from squish.attention.gqa import GQACache, GQAConfig
    ...
    def test_grouped_query_attention_output_shape(self):
        from squish.attention.gqa import GQAConfig, grouped_query_attention
    ...
    def test_gqa_stats_memory_ratio_and_reset(self):
        from squish.attention.gqa import GQACache, GQAConfig, GQAStats
...
class TestSlidingWindowAttnWiring:
    def test_import_and_config_defaults(self):
        from squish.attention.sliding_window_attn import SWAConfig
...
class TestRoPEScalingWiring:
    ...
    def test_create_rope_scaler_factory(self):
        from squish.attention.rope_scaling import (
            LongRoPEScaler,
            NTKScaler,
            RoPEConfig,
            YaRNScaler,
    ...
    def test_ntk_scaler_apply_output_shape(self):
        from squish.attention.rope_scaling import NTKScaler, RoPEConfig
    ...
    def test_yarn_longrope_get_freqs_shape(self):
        from squish.attention.rope_scaling import LongRoPEScaler, RoPEConfig, YaRNScaler
...
class TestActSparsityWiring:
    def test_import_and_config_validation(self):
        from squish.token.act_sparsity import SparsityConfig
    ...
    def test_sparse_ffn_gate_apply_and_compression(self):
        from squish.token.act_sparsity import SparseFFNGate, SparsityConfig
    ...
    def test_act_sparsity_stats_properties(self):
        from squish.token.act_sparsity import ActSparsityStats
...
class TestFusedRMSNormWiring:
    def test_import_and_config_validation(self):
        from squish.hardware.fused_rmsnorm import FusedNormConfig
    ...
    def test_fused_add_rms_norm_function(self):
        from squish.hardware.fused_rmsnorm import fused_add_rms_norm
...
class TestMedusaWiring:
    def test_import_and_config_validation(self):
        from squish.speculative.medusa import MedusaConfig
    ...
    def test_decoder_draft_returns_tree(self):
        from squish.speculative.medusa import MedusaConfig, MedusaDecoder, MedusaDraftTree
    ...
    def test_decoder_verify_greedy(self):
        from squish.speculative.medusa import MedusaConfig, MedusaDecoder
    ...
    def test_medusa_stats_and_throughput_multiplier(self):
        from squish.speculative.medusa import MedusaConfig, MedusaDecoder, MedusaStats
...
class TestEagle3Wiring:
    def test_import_and_config_feature_dim_default(self):
        from squish.speculative.eagle3 import Eagle3Config
    ...
    def test_draft_head_forward_shapes(self):
        from squish.speculative.eagle3 import Eagle3Config, Eagle3DraftHead
...
class TestTokenHealerWiring:
    def test_import_and_config_validation(self):
        from squish.token.token_healer import HealerConfig
    ...
    def test_find_suffix_overlap_detects_prefix(self):
        from squish.token.token_healer import HealerConfig, TokenHealer
