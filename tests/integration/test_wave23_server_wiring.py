...
class TestRAGPrefetch:
    def test_imports(self):
        from squish.context.rag_prefetch import RAGConfig, RAGPrefetcher, RAGStats
        assert RAGConfig is not None
        assert RAGPrefetcher is not None
        assert RAGStats is not None

    def test_record_access(self):
        from squish.context.rag_prefetch import RAGConfig, RAGPrefetcher
...
class TestStreamRAG:
    ...
    def test_inject_and_retrieve(self):
        from squish.streaming.stream_rag import StreamRAGConfig, StreamRAGInjector
...
class TestLongContextChunk:
    ...
    def test_chunk_covers_sequence(self):
        from squish.streaming.long_context_chunk import ChunkConfig, LongContextChunker
